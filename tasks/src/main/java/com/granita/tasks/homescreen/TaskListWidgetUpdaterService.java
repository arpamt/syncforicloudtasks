...
package com.granita.tasks.homescreen;
...
import com.granita.tasks.utils.WidgetConfigurationDatabaseHelper;
...
public class TaskListWidgetUpdaterService extends RemoteViewsService
{
	...
	public static class TaskListViewsFactory implements RemoteViewsService.RemoteViewsFactory, TimeChangeListener
	{
		...
		/*
		 * @see com.granita.tasks.utils.TimeChangeListener#onTimeUpdate(com.granita.tasks.utils.TimeChangeObserver)
		 */
		@Override
		 ...
		 * 
		 * @see com.granita.tasks.utils.TimeChangeListener#onAlarm(com.granita.tasks.utils.TimeChangeObserver)
		 */
		@Override
