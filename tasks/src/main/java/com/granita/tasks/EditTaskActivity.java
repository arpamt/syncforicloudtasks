...
public class EditTaskActivity extends ActionBarActivity
{
	...
	final static String EXTRA_DATA_CONTENT_SET = "com.granita.DATA";

	public final static String EXTRA_DATA_ACCOUNT_TYPE = "com.granita.ACCOUNT_TYPE";
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		//custom start
		Tracker t = ((com.granita.tasks.Tasks) getApplication()).getTracker(
				com.granita.tasks.Tasks.TrackerName.APP_TRACKER);
