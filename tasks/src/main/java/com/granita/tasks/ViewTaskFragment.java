...
import com.granita.tasks.model.OnContentChangeListener;
import com.granita.tasks.model.Sources;
import com.granita.tasks.model.TaskFieldAdapters;
import com.granita.tasks.utils.ContentValueMapper;
import com.granita.tasks.utils.OnModelLoadedListener;
import com.granita.tasks.widget.ListenableScrollView;
import com.granita.tasks.widget.ListenableScrollView.OnScrollListener;
import com.granita.tasks.widget.TaskView;
...
public class ViewTaskFragment extends SupportFragment implements OnModelLoadedListener, OnContentChangeListener
{
	...
	private void completeTask()
	{
		...
		//Toast.makeText(mAppContext, getString(R.string.disableedit, TaskFieldAdapters.TITLE.get(mContentSet)), Toast.LENGTH_SHORT).show();
		//custom end
	}
