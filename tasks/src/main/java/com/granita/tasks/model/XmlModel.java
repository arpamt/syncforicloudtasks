...
import com.granita.tasks.model.adapters.FieldAdapter;
import com.granita.tasks.model.adapters.StringFieldAdapter;
import com.granita.tasks.model.contraints.UpdateAllDay;
import com.granita.tasks.model.layout.LayoutDescriptor;
...
{
	private final static String TAG = "com.granita.tasks.model.XmlModel";

	public final static String METADATA_TASKS = "com.granita.tasks.TASKS";

	public final static String NAMESPACE = "com.granita.tasks";
