...
import com.granita.tasks.utils.DateFormatter;
import com.granita.tasks.utils.DateFormatter.DateFormatContext;
import com.granita.tasks.utils.ObservableSparseArrayCompat;
...
public class NotificationActionUtils
{
	...
	public final static String ACTION_UNDO = "com.granita.tasks.action.notification.UNDO";
	public final static String ACTION_DESTRUCT = "com.granita.tasks.action.notification.DESTRUCT";
	public final static String ACTION_UNDO_TIMEOUT = "com.granita.tasks.action.notification.ACTION_UNDO_TIMEOUT";

	public final static String EXTRA_NOTIFICATION_ACTION = "com.granita.tasks.extra.notification.EXTRA_NOTIFICATION_ACTION";
