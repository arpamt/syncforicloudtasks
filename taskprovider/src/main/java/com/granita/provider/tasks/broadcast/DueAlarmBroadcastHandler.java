...
public class DueAlarmBroadcastHandler extends BroadcastReceiver
{
	...
	public final static String EXTRA_TASK_ID = "com.granita.provider.tasks.extra.task_id";
	public final static String EXTRA_TASK_DUE_TIME = "com.granita.provider.tasks.extra.task_due";
	public final static String EXTRA_TASK_DUE_ALLDAY = "com.granita.provider.tasks.extra.task_due_allday";
	public final static String EXTRA_TASK_TIMEZONE = "com.granita.provider.tasks.extra.task_timezone";
	public final static String EXTRA_TASK_TITLE = "com.granita.provider.tasks.extra.task_title";
	...
	public final static String BROADCAST_DUE_ALARM = "com.granita.android.tasks.TASK_DUE";
